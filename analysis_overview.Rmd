...
* Some modifications, such as transforming words into lowercase, are usually implemented to make sure the model understands that, e.g. `Cabin` and `cabin` are the same concept

* Once we have extracted the *tokens* from raw text, we can analyze things such as how often they appear
